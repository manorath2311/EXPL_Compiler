...
expr : expr PLUS_T expr		{$$ = makeExprNode(INT_NODE_CONST, '+',$1, $3);}
	| expr MINUS_T expr  	{$$ = makeExprNode(INT_NODE_CONST, '-',$1, $3);}
	| expr MUL_T expr	{$$ = makeExprNode(INT_NODE_CONST, '*',$1, $3);}
	| expr DIV_T expr	{$$ = makeExprNode(INT_NODE_CONST, '/',$1, $3);}
	| '(' expr ')' 	{$$ = $2;}
	| NUM_T		{$$ = $1;}
	| ID_T	{$$ = $1;}
